...
import SchemaDeliverableService from "../../../services/Deliverables/Schemas/schema.deliverable.service";
import AddSchemaDeliverableModal from "../../../components/organisms/Forms/AddSchemaDeliverableModal";
import Swal from "sweetalert2";
import { normalizeList } from "../../../utils/api-helpers";

const SchemasDeliverablesPage = () => {
  ...
  const fetchSchemas = useCallback(async () => {
    setLoading(true);
    try {
      const response = await SchemaDeliverableService.getAllSchemas({
  ...
  const handleDelete = async (id, clientKey) => {
    ...
    if (result.isConfirmed) {
      try {
        await SchemaDeliverableService.deleteSchema(id);
  ...
  const handleValidate = async (id) => {
    try {
      ...
      const res = await SchemaDeliverableService.validateSchema(id);
...
export default SchemasDeliverablesPage;