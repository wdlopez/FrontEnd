...
import SchemaInvoiceService from "../../../services/Invoices/Schemas/schema.invoice.service";
import AddSchemaInvoiceModal from "../../../components/organisms/Forms/AddSchemaInvoiceModal";
import Swal from "sweetalert2";
import { normalizeList } from "../../../utils/api-helpers";

const SchemasInvoicesPage = () => {
  ...
  const fetchSchemas = useCallback(async () => {
    setLoading(true);
    try {
      const response = await SchemaInvoiceService.getAllSchemas({
  ...
  const handleDelete = async (id, clientKey) => {
    ...
    if (result.isConfirmed) {
      try {
        await SchemaInvoiceService.deleteSchema(id);
  ...
  const handleValidate = async (id) => {
    try {
      ...
      const res = await SchemaInvoiceService.validateSchema(id);
...
export default SchemasInvoicesPage;