...
import SchemaService from "../../../services/Contracts/Schemas/schema.service";
import AddSchemaModal from "../../../components/organisms/Forms/AddSchemaModal";
...
const SchemasPage = () => {
  ...
  const handleValidate = async (id) => {
    try {
      ...
      const res = await SchemaService.validateSchema(id);
