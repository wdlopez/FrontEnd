export const SERVICE_CONFIG = {
  ...
  columns: [
    ...
    },
    {
      ...
      editable: true,
      required: true,
      validation: /^[a-zA-Z0-9À-ÿ\u00f1\u00d1\s\-().\/]{1,50}$/,
      validationMessage: "Letras, números, espacios, guiones, paréntesis o barras (máx. 50)",
    },
    {
    ...
    },
    {
      ...
      editable: true,
      required: true,
      // El backend valida entre 1 y 20 caracteres
      validation: /^[a-zA-Z0-9À-ÿ\u00f1\u00d1\s\-().\/]{1,20}$/,
      validationMessage: "La unidad de recurso debe tener entre 1 y 20 caracteres",
    },
    {
