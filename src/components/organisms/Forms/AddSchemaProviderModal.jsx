...
import SchemaProviderService from "../../../services/Providers/Schemas/schema.service";
import Swal from "sweetalert2";
import InfoTooltip from "../../atoms/InfoToolTip";
import { getText } from "../../../utils/text";

const AddSchemaProviderModal = ({ isOpen, setIsOpen, onSuccess }) => {
  ...
  const schemaFields = [
    {
      ...
      placeholder: "ej: empresa_cliente",
      required: true,
    ...
    },
    {
      ...
      placeholder: "ej: schema_empresa_prod",
      required: false,
      maxLength: 150,
  ...
  const handleCreateSchema = async (formData) => {
    ...
    setLoading(true);
    try {
      await SchemaProviderService.createSchema(formData);
  ...
  return (
    <Modal size="md" open={isOpen} setOpen={setIsOpen}>
      <div className="flex gap-2 items-center mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-800">Nuevo Esquema de Proveedor</h2>
      </div>
...
export default AddSchemaProviderModal;