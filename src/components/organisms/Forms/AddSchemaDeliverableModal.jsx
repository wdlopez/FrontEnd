...
const AddSchemaDeliverableModal = ({ isOpen, setIsOpen, onSuccess }) => {
  ...
  const handleCreateSchema = async (formData) => {
    ...
    setLoading(true);
    try {
      await SchemaDeliverableService.createSchema(formData);
...
export default AddSchemaDeliverableModal;